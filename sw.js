...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-9811de","is-html-9811de","is-jsdelivr-9811de","is-gtm-9811de","is-gravatar-9811de","is-theme-9811de","is-cdn-9811de","is-json-9811de"];
      return Promise.all(
        names
