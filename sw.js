...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-380e1d","is-html-380e1d","is-jsdelivr-380e1d","is-gtm-380e1d","is-gravatar-380e1d","is-theme-380e1d","is-cdn-380e1d","is-json-380e1d"];
      return Promise.all(
        names
