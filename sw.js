...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-205e02","is-html-205e02","is-jsdelivr-205e02","is-gtm-205e02","is-gravatar-205e02","is-theme-205e02","is-cdn-205e02","is-json-205e02"];
      return Promise.all(
        names
