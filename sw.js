...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-c9caaa","is-html-c9caaa","is-jsdelivr-c9caaa","is-gtm-c9caaa","is-gravatar-c9caaa","is-theme-c9caaa","is-cdn-c9caaa","is-json-c9caaa"];
      return Promise.all(
        names
