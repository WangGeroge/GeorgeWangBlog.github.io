...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-82d793","is-html-82d793","is-jsdelivr-82d793","is-gtm-82d793","is-gravatar-82d793","is-theme-82d793","is-cdn-82d793","is-json-82d793"];
      return Promise.all(
        names
