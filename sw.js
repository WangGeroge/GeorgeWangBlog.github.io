...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-93109d","is-html-93109d","is-jsdelivr-93109d","is-gtm-93109d","is-gravatar-93109d","is-theme-93109d","is-cdn-93109d","is-json-93109d"];
      return Promise.all(
        names
