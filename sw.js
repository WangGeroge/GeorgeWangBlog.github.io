...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-8bc39d","is-html-8bc39d","is-jsdelivr-8bc39d","is-gtm-8bc39d","is-gravatar-8bc39d","is-theme-8bc39d","is-cdn-8bc39d","is-json-8bc39d"];
      return Promise.all(
        names
