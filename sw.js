...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-773ded","is-html-773ded","is-jsdelivr-773ded","is-gtm-773ded","is-gravatar-773ded","is-theme-773ded","is-cdn-773ded","is-json-773ded"];
      return Promise.all(
        names
