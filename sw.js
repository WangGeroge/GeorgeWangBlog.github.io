...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-b1303c","is-html-b1303c","is-jsdelivr-b1303c","is-gtm-b1303c","is-gravatar-b1303c","is-theme-b1303c","is-cdn-b1303c","is-json-b1303c"];
      return Promise.all(
        names
