...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-3019bf","is-html-3019bf","is-jsdelivr-3019bf","is-gtm-3019bf","is-gravatar-3019bf","is-theme-3019bf","is-cdn-3019bf","is-json-3019bf"];
      return Promise.all(
        names
