...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-b09a9c","is-html-b09a9c","is-jsdelivr-b09a9c","is-gtm-b09a9c","is-gravatar-b09a9c","is-theme-b09a9c","is-cdn-b09a9c","is-json-b09a9c"];
      return Promise.all(
        names
