...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-dca27d","is-html-dca27d","is-jsdelivr-dca27d","is-gtm-dca27d","is-gravatar-dca27d","is-theme-dca27d","is-cdn-dca27d","is-json-dca27d"];
      return Promise.all(
        names
