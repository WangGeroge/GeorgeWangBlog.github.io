...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-2cb73e","is-html-2cb73e","is-jsdelivr-2cb73e","is-gtm-2cb73e","is-gravatar-2cb73e","is-theme-2cb73e","is-json-2cb73e"];
      return Promise.all(
        names
