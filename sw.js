...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-192860","is-html-192860","is-jsdelivr-192860","is-gtm-192860","is-gravatar-192860","is-theme-192860","is-cdn-192860","is-json-192860"];
      return Promise.all(
        names
