...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-df037a","is-html-df037a","is-jsdelivr-df037a","is-gtm-df037a","is-gravatar-df037a","is-theme-df037a","is-json-df037a"];
      return Promise.all(
        names
