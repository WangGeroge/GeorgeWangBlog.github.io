...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-0dc064","is-html-0dc064","is-jsdelivr-0dc064","is-gtm-0dc064","is-gravatar-0dc064","is-theme-0dc064","is-cdn-0dc064","is-json-0dc064"];
      return Promise.all(
        names
