...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-1fa1c4","is-html-1fa1c4","is-jsdelivr-1fa1c4","is-gtm-1fa1c4","is-gravatar-1fa1c4","is-theme-1fa1c4","is-cdn-1fa1c4","is-json-1fa1c4"];
      return Promise.all(
        names
