...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-b103d6","is-html-b103d6","is-jsdelivr-b103d6","is-gtm-b103d6","is-gravatar-b103d6","is-theme-b103d6","is-json-b103d6"];
      return Promise.all(
        names
