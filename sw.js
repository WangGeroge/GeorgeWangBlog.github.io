...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-0c1a37","is-html-0c1a37","is-jsdelivr-0c1a37","is-gtm-0c1a37","is-gravatar-0c1a37","is-theme-0c1a37","is-cdn-0c1a37","is-json-0c1a37"];
      return Promise.all(
        names
