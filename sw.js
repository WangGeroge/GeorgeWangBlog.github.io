...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-4a2fb8","is-html-4a2fb8","is-jsdelivr-4a2fb8","is-gtm-4a2fb8","is-gravatar-4a2fb8","is-theme-4a2fb8","is-cdn-4a2fb8","is-json-4a2fb8"];
      return Promise.all(
        names
