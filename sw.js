...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-1eef4c","is-html-1eef4c","is-jsdelivr-1eef4c","is-gtm-1eef4c","is-gravatar-1eef4c","is-theme-1eef4c","is-cdn-1eef4c","is-json-1eef4c"];
      return Promise.all(
        names
