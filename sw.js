...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-15dc65","is-html-15dc65","is-jsdelivr-15dc65","is-gtm-15dc65","is-gravatar-15dc65","is-theme-15dc65","is-json-15dc65"];
      return Promise.all(
        names
