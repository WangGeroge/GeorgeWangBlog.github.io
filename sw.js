...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-22752c","is-html-22752c","is-jsdelivr-22752c","is-gtm-22752c","is-gravatar-22752c","is-theme-22752c","is-cdn-22752c","is-json-22752c"];
      return Promise.all(
        names
